...
class PostureFlags {
  ...
  PostureFlags({
    required this.turtleNeck,
    required this.forwardLean,
    required this.reclined,
    required this.sideSlouch,
    required this.legCrossSuspect,
    required this.thinkingPose,
    required this.perching,
...
class MonitoringMetric {
  final double score;
  final String level; // 'good' | 'warning' | 'danger'
